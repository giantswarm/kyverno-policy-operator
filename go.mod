...
replace github.com/sigstore/cosign/v2 v2.2.2 => github.com/sigstore/cosign/v2 v2.4.0

replace golang.org/x/crypto v0.25.0 => golang.org/x/crypto v0.38.0

replace github.com/golang-jwt/jwt/v4 v4.5.0 => github.com/golang-jwt/jwt/v4 v4.5.2

replace (
	github.com/open-policy-agent/opa v0.67.0 => github.com/open-policy-agent/opa v1.4.2
	github.com/open-policy-agent/opa v1.1.0 => github.com/open-policy-agent/opa v1.4.2
)
