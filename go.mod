...
replace github.com/containerd/containerd/v2 v2.2.1 => github.com/containerd/containerd/v2 v2.3.2

replace github.com/go-git/go-billy/v5 v5.8.0 => github.com/go-git/go-billy/v5 v5.9.0

replace github.com/go-git/go-git/v5 v5.18.0 => github.com/go-git/go-git/v5 v5.19.1

replace (
	github.com/go-jose/go-jose/v3 v3.0.3 => github.com/go-jose/go-jose/v3 v3.0.5
	github.com/go-jose/go-jose/v3 v3.0.4 => github.com/go-jose/go-jose/v3 v3.0.5
)

replace golang.org/x/sys v0.43.0 => golang.org/x/sys v0.46.0

replace go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.40.0 => go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracehttp v1.44.0

replace go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp v0.42.0 => go.opentelemetry.io/otel/exporters/otlp/otlpmetric/otlpmetrichttp v1.44.0
...
replace go.etcd.io/etcd/v3 v3.6.8 => go.etcd.io/etcd/v3 v3.6.12
...
replace (
	github.com/klauspost/compress v1.18.5 => github.com/klauspost/compress v1.20.0
	github.com/klauspost/compress v1.18.6 => github.com/klauspost/compress v1.20.0
)
